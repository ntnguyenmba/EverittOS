...
const en: DashboardFinanceCopy = {
  ...
  metricTitles: {
    ...
    'worker-pay': 'Worker cost',
    'worker-pay-owed': 'Worker pay owed',
    'worker-pay-pending': 'Worker pay pending',
    expenses: 'Expenses',
  ...
  formulas: {
    ...
    'net-cash':
      'Money kept = money received minus paid workers minus business expenses.',
    'estimated-profit':
      'Profit = job revenue minus worker costs minus business expenses. Job revenue = money received + customers owe.',
    'worker-pay': 'Worker costs = labor totals for jobs in the selected period.',
    'worker-pay-owed': 'Worker pay owed = labor still marked unpaid.',
    'worker-pay-pending': 'Worker pay pending = labor marked pending.',
  ...
  money: {
    ...
    netCash: 'Money kept',
    netCashHelp:
      'Money received minus paid workers minus business expenses.',
    ...
    contractorCost: 'Worker costs',
    contractorCostHelp: 'Total labor cost for jobs in this period, paid or unpaid.',
    contractorPay: 'Worker costs',
    contractorPayHelp: 'Total labor cost for jobs in this period, paid or unpaid.',
    contractorPayOwed: 'Worker pay owed',
    contractorPayOwedHelp: 'Unpaid worker labor for jobs attributed to the selected period.',
    contractorPayPending: 'Worker pay pending',
    contractorPayPendingHelp: 'Worker pay marked pending but not yet marked paid.',
    contractorPayPaid: 'Paid workers',
    contractorPayPaidHelp: 'Worker payments actually marked paid in this period (by paid_at).',
    otherExpenses: 'Business expenses',
    otherExpensesHelp: 'Recorded business expenses dated in the selected period.',
    expectedProfit: 'Profit',
    expectedProfitHelp:
      'Profit = Job revenue − Worker costs − Business expenses.',
    cashAfterCosts: 'Money kept',
    cashAfterCostsHelp: 'Money received minus paid workers minus business expenses.',
  ...
  contractorPayPage: {
    title: 'Team Pay',
    subtitle: 'Review worker and employee payments linked to jobs.',
    privacyNotice:
      'Private company financial information. Only owners, managers, and authorized employees can view or manage team pay. Workers and customers cannot see this section.',
...
const es: DashboardFinanceCopy = {
  ...
  metricTitles: {
    ...
    'worker-pay': 'Costo de trabajadores',
    'worker-pay-owed': 'Pago a trabajadores adeudado',
    'worker-pay-pending': 'Pago a trabajadores pendiente',
    expenses: 'Gastos',
  ...
  formulas: {
    ...
    'net-cash':
      'Efectivo después de costos pagados = pagos recibidos menos pagos a trabajadores pagados menos gastos pagados.',
    'estimated-profit':
      'Ganancia esperada = ingresos esperados menos costo de trabajadores menos otros gastos registrados.',
    'worker-pay': 'Costo de trabajadores = totales de mano de obra registrados en el período.',
    'worker-pay-owed': 'Adeudado = mano de obra aún marcada como no pagada.',
    'worker-pay-pending': 'Pendiente = mano de obra marcada como pendiente.',
  ...
  money: {
    ...
    netCashHelp:
      'Pagos recibidos menos pagos a trabajadores pagados menos gastos pagados.',
    ...
    contractorCost: 'Costo de trabajadores',
    contractorCostHelp: 'Mano de obra de trabajadores de trabajos en este período.',
    contractorPay: 'Costo de trabajadores',
    contractorPayHelp: 'Mano de obra de trabajadores de trabajos en este período.',
    contractorPayOwed: 'Pago a trabajadores adeudado',
    contractorPayPending: 'Pago a trabajadores pendiente',
    contractorPayPaid: 'Pago a trabajadores pagado',
    contractorPayPaidHelp: 'Pagos a trabajadores realmente hechos en este período.',
    otherExpenses: 'Otros gastos',
    expectedProfit: 'Ganancia esperada',
    expectedProfitHelp: 'Ingresos esperados menos costo de trabajadores y otros gastos.',
    cashAfterCosts: 'Efectivo después de costos pagados',
    cashAfterCostsHelp:
      'Pagos recibidos menos costos de trabajadores pagados y gastos pagados.',
  ...
  contractorPayPage: {
    ...
    subtitle: 'Revise los pagos a trabajadores y empleados vinculados a trabajos.',
    privacyNotice:
      'Información financiera privada de la empresa. Solo propietarios, gerentes y empleados autorizados pueden ver o gestionar el pago del equipo. Los trabajadores y clientes no pueden ver esta sección.',
    ...
    unnamed: 'Trabajador sin asignar',
    jobFallback: 'Trabajo',
...
const vi: DashboardFinanceCopy = {
  ...
  metricTitles: {
    ...
    'worker-pay': 'Chi phí thầu phụ',
    'worker-pay-owed': 'Còn nợ thầu phụ',
    'worker-pay-pending': 'Thầu phụ đang chờ',
    expenses: 'Chi phí',
  ...
  formulas: {
    ...
    'worker-pay': 'Chi phí thầu phụ = tổng chi phí nhân công ghi nhận trong kỳ.',
    'worker-pay-owed': 'Còn nợ = nhân công vẫn đánh dấu chưa trả.',
    'worker-pay-pending': 'Đang chờ = nhân công đánh dấu đang chờ.',
