...
export const portalMessagesEn: PortalMessages = {
  ...
  client: {
    ...
    loadingPortal: 'Loading your client portal...',
    ...
    growthRequired: 'Client portal requires Growth plan or higher, or a client role.',
  ...
  contractor: {
    ...
    yourPay: 'Your pay',
    growthRequired: 'Contractor portal requires Growth plan or a contractor role.',
...
export const portalMessagesEs: PortalMessages = {
  ...
  client: {
    ...
    loadingPortal: 'Cargando tu portal de cliente...',
    ...
    growthRequired: 'El portal del cliente requiere el plan Growth o superior, o un rol de cliente.',
  ...
  contractor: {
    ...
    yourPay: 'Tu pago',
    growthRequired: 'El portal del contratista requiere el plan Growth o un rol de contratista.',
...
export const portalMessagesVi: PortalMessages = {
  ...
  client: {
    ...
    loadingPortal: 'Đang tải cổng thông tin khách hàng...',
    ...
    growthRequired: 'Cổng thông tin khách hàng yêu cầu gói Growth trở lên, hoặc vai trò khách hàng.',
  ...
  contractor: {
    ...
    growthRequired: 'Cổng thông tin nhà thầu yêu cầu gói Growth hoặc vai trò nhà thầu.',
