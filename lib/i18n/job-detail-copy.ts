...
const copy: Record<Locale, JobDetailCopy> = {
  en: {
    ...
    overviewCopy: 'Update the job here without entering the schedule or worker again.', email: 'Email', title: 'Job', customer: 'Customer', phone: 'Phone', address: 'Address',
  ...
  es: {
    ...
    jobDetails: 'Detalles', jobDetailsReadOnly: 'Detalles', overview: 'Resumen', overviewCopy: 'Actualiza el trabajo aquí sin volver a ingresar el horario ni el trabajador.',
  ...
  vi: {
    ...
    overviewCopy: 'Cập nhật công việc tại đây mà không cần nhập lại lịch hoặc nhân viên.', email: 'Email', title: 'Công việc', customer: 'Khách hàng', phone: 'Điện thoại', address: 'Địa chỉ',
