...
export const PLAN_TIER_ROWS: PlanTierRow[] = [
  {
    ...
    advancedReporting: false, pdfReports: false, reports: 0, brandedReports: false, catchGrowth: false
  },
  {
    ...
    advancedReporting: false, pdfReports: true, reports: 25, brandedReports: false, catchGrowth: false
  },
  {
    ...
    aiUnlimited: false, apiAccess: false, prioritySupport: false, bookings: true,
    advancedReporting: true, pdfReports: true, reports: 150, brandedReports: false, catchGrowth: false
  },
  {
    ...
    clientPortal: false, contractorPortal: false, beforeAfterPhotos: true, aiAccess: true,
    aiUnlimited: false, apiAccess: false, prioritySupport: false, bookings: true,
    advancedReporting: true, pdfReports: true, reports: 500, brandedReports: true, catchGrowth: false
  },
  {
    ...
    advancedReporting: true, pdfReports: true, reports: 2500, brandedReports: true, catchGrowth: false
  },
  {
    ...
    advancedReporting: true, pdfReports: true, reports: UNLIMITED_CAP, brandedReports: true, catchGrowth: true
  }
];
