...
const bottomCopy = {
  ...
  vi: { home: 'Trang chủ', jobs: 'Công việc', customers: 'Khách hàng', calendar: 'Lịch', more: 'Thêm', workspace: 'Không gian làm việc', language: 'Ngôn ngữ', logout: 'Đăng xuất', close: 'Đóng', showAll: 'Hiện tất cả công việc', showLess: 'Hiện ít công việc hơn' }
} as const;
