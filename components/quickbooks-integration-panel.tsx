...
const COPY: Record<'en' | 'es' | 'vi', Copy> = {
  en: {
    connectHint: 'Connect QuickBooks to share accounting data.',
    ...
    exportLine: 'Customers, invoices, and payments are sent to QuickBooks.', importLine: 'Expenses from QuickBooks are added to EverittOS.', reconcileLine: 'Payments are matched with invoices automatically.',
    accountingTitle: 'Why the numbers can be different', accountingIntro: 'EverittOS runs your daily work. QuickBooks keeps your accounting records. The totals may not always match.', sentTitle: 'Sent to QuickBooks', sentItems: 'Customers, invoices, payments, and expenses.', staysTitle: 'Only in EverittOS', staysItems: 'Jobs, schedule, expected revenue, expected profit, team, photos, and reports.', differenceNote: 'Expected revenue is work that has not been paid yet. Collected is money recorded in EverittOS.',
  ...
  es: {
    connectHint: 'Conecta QuickBooks para compartir datos contables.',
    ...
    exportLine: 'Los clientes, las facturas y los pagos se envían a QuickBooks.', importLine: 'Los gastos de QuickBooks se añaden a EverittOS.', reconcileLine: 'Los pagos se relacionan con las facturas automáticamente.',
    accountingTitle: 'Por qué los números pueden ser diferentes', accountingIntro: 'EverittOS organiza el trabajo diario. QuickBooks guarda los registros contables. Los totales no siempre serán iguales.', sentTitle: 'Se envía a QuickBooks', sentItems: 'Clientes, facturas, pagos y gastos.', staysTitle: 'Solo en EverittOS', staysItems: 'Trabajos, calendario, ingresos esperados, ganancia esperada, equipo, fotos e informes.', differenceNote: 'Los ingresos esperados son trabajo que aún no se ha pagado. Cobrado es dinero registrado en EverittOS.',
  ...
  vi: {
    connectHint: 'Kết nối QuickBooks để chia sẻ dữ liệu kế toán.',
    ...
    exportLine: 'Khách hàng, hóa đơn và khoản thanh toán được gửi sang QuickBooks.', importLine: 'Chi phí từ QuickBooks được thêm vào EverittOS.', reconcileLine: 'Khoản thanh toán được tự động khớp với hóa đơn.',
    accountingTitle: 'Vì sao các con số có thể khác nhau', accountingIntro: 'EverittOS quản lý công việc hằng ngày. QuickBooks lưu sổ sách kế toán. Tổng số có thể không giống nhau.', sentTitle: 'Gửi sang QuickBooks', sentItems: 'Khách hàng, hóa đơn, khoản thanh toán và chi phí.', staysTitle: 'Chỉ có trong EverittOS', staysItems: 'Công việc, lịch, doanh thu dự kiến, lợi nhuận dự kiến, đội ngũ, hình ảnh và báo cáo.', differenceNote: 'Doanh thu dự kiến là công việc chưa được thanh toán. Đã thu là tiền được ghi nhận trong EverittOS.',
