  ...
  return (
    <header className={`mobile-nav${isFocusedPortal ? ' mobile-nav-focused-portal' : ''}${open ? ' mobile-nav-open' : ''}`} aria-label={t('ux.mobileNavLabel')}>
      ...
      <style>{`
        ...
        .mobile-nav-overlay-portal{position:fixed;inset:0;z-index:2147483000;padding:max(12px,env(safe-area-inset-top)) 12px max(12px,env(safe-area-inset-bottom));display:flex;align-items:flex-start;justify-content:center;background:rgba(23,32,51,.48);pointer-events:auto!important}.mobile-nav-drawer{position:relative;z-index:2147483001;width:100%;height:calc(100dvh - max(24px,env(safe-area-inset-top)) - max(24px,env(safe-area-inset-bottom)));max-height:900px;display:grid;grid-template-rows:auto minmax(0,1fr) auto;border:1px solid #315F70;border-radius:28px;background:#172033;color:#FFFFFF;box-shadow:0 18px 60px rgba(23,32,51,.28);overflow:hidden;pointer-events:auto!important}.mobile-nav-drawer-head{min-height:72px;padding:10px 12px 10px 18px;display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid rgba(255,255,255,.14);background:#172033}.mobile-nav-brand-logo{color:#FFFFFF!important;font-weight:750}.mobile-nav-brand-logo .brand-logo-name{color:#FFFFFF!important;font-size:21px!important}.mobile-nav-close-btn{width:48px;height:48px;border:1px solid rgba(255,255,255,.32);border-radius:50%;display:flex;align-items:center;justify-content:center;background:#234A84;color:#FFFFFF;font-size:27px;font-weight:400;line-height:1;cursor:pointer}.mobile-nav-panel{overflow-y:auto;padding:22px 22px 28px;background:#172033}.mobile-nav-panel .app-nav{display:grid;grid-template-columns:1fr;gap:0}.mobile-nav-drawer-link{min-height:54px!important;margin:0!important;padding:13px 4px!important;display:flex!important;align-items:center!important;justify-content:space-between!important;border:0!important;border-bottom:1px solid rgba(255,255,255,.12)!important;border-radius:0!important;background:#172033!important;color:#FFFFFF!important;font-size:18px!important;font-weight:600!important;line-height:1.3!important;text-decoration:none!important;box-shadow:none!important}.mobile-nav-drawer-link .nav-item-label{color:#FFFFFF!important}.mobile-nav-drawer-link:hover,.mobile-nav-drawer-link:focus-visible{background:#1E3F72!important;color:#FFFFFF!important}.mobile-nav-drawer-link.active,.mobile-nav-drawer-link[aria-current='page']{padding-left:14px!important;border-bottom-color:#4F7CC4!important;border-radius:12px!important;background:#234A84!important;color:#FFFFFF!important}.mobile-nav-drawer-link.active .nav-item-label,.mobile-nav-drawer-link[aria-current='page'] .nav-item-label{color:#FFFFFF!important}.mobile-nav-drawer-footer{display:grid;grid-template-columns:1fr 1fr;align-items:end;gap:10px;padding:16px 22px max(20px,env(safe-area-inset-bottom));border-top:1px solid rgba(255,255,255,.14);background:#1E3F72;color:#FFFFFF}.mobile-nav-drawer-footer label,.mobile-nav-drawer-footer span{color:#FFFFFF!important}.mobile-nav-drawer-footer select{width:100%;min-height:46px;border:1px solid #DDE6F2;border-radius:13px;background:#FFFFFF;color:#172033}.mobile-nav-logout{grid-column:1/-1;min-height:50px;padding:0 18px;border:1px solid #FFFFFF;border-radius:999px;background:#FFFFFF;color:#234A84;font:inherit;font-weight:750;cursor:pointer}body.mobile-nav-open{overflow:hidden}
