...
export function MobileNav({ plan, role: roleProp }: MobileNavProps) {
  ...
  return (
    <header className={`mobile-nav${isFocusedPortal ? ' mobile-nav-focused-portal' : ''}${open ? ' mobile-nav-open' : ''}`} aria-label={t('ux.mobileNavLabel')}>
      ...
      <style>{`
        .mobile-nav{width:100%;border:0;background:transparent}.mobile-nav-bar{min-height:64px;width:100%;padding:8px 10px 8px 14px;display:flex;align-items:center;justify-content:space-between;gap:14px;box-sizing:border-box;border:1px solid rgba(221,230,242,.92);border-radius:24px;background:rgba(255,255,255,.97);box-shadow:0 8px 26px rgba(23,32,51,.11);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}.mobile-nav-actions{display:flex;align-items:center;gap:7px}.mobile-nav-top-logo{min-width:0;display:inline-flex;align-items:center;gap:10px;color:#172033!important;font-weight:750;text-decoration:none}.mobile-nav-top-logo .brand-logo-image{display:block;border-radius:10px}.mobile-nav-top-logo .brand-logo-name{color:#172033!important;font-size:18px!important;line-height:1!important;white-space:nowrap}.mobile-nav-search-btn,.mobile-nav-menu-btn{position:relative;z-index:2147482999;width:44px;height:44px;display:inline-flex;align-items:center;justify-content:center;border:1px solid #DDE6F2;border-radius:50%;background:#F8FAFC;color:#172033;box-shadow:none;cursor:pointer;pointer-events:auto!important;touch-action:manipulation}.mobile-nav-search-icon{position:relative;width:16px;height:16px;border:2px solid #234A84;border-radius:50%;box-sizing:border-box}.mobile-nav-search-icon:after{content:'';position:absolute;width:7px;height:2px;right:-5px;bottom:-2px;border-radius:999px;background:#234A84;transform:rotate(45deg)}.mobile-nav-menu-icon,.mobile-nav-menu-icon:before,.mobile-nav-menu-icon:after{display:block;width:18px;height:2px;border-radius:999px;background:#172033}.mobile-nav-menu-icon{position:relative}.mobile-nav-menu-icon:before,.mobile-nav-menu-icon:after{content:'';position:absolute;left:0}.mobile-nav-menu-icon:before{top:-6px}.mobile-nav-menu-icon:after{top:6px}
        .mobile-nav-overlay-portal{position:fixed;inset:0;z-index:2147483000;padding:max(12px,env(safe-area-inset-top)) 12px max(12px,env(safe-area-inset-bottom));display:flex;align-items:flex-start;justify-content:center;background:rgba(23,32,51,.24);backdrop-filter:blur(7px);-webkit-backdrop-filter:blur(7px);pointer-events:auto!important}.mobile-nav-drawer{position:relative;z-index:2147483001;width:100%;height:calc(100dvh - max(24px,env(safe-area-inset-top)) - max(24px,env(safe-area-inset-bottom)));max-height:900px;display:grid;grid-template-rows:auto minmax(0,1fr) auto;border:1px solid #DDE6F2;border-radius:28px;background:#fff;color:#172033;box-shadow:0 18px 60px rgba(23,32,51,.16);overflow:hidden;pointer-events:auto!important}.mobile-nav-drawer-head{min-height:72px;padding:10px 12px 10px 18px;display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid #E7EEF7;background:#fff}.mobile-nav-brand-logo{color:#172033!important;font-weight:750}.mobile-nav-brand-logo .brand-logo-name{color:#172033!important;font-size:21px!important}.mobile-nav-close-btn{width:48px;height:48px;border:1px solid #DDE6F2;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#fff;color:#172033;font-size:27px;font-weight:400;line-height:1;cursor:pointer}.mobile-nav-panel{overflow-y:auto;padding:22px 22px 28px;background:#fff}.mobile-nav-panel .app-nav{display:grid;grid-template-columns:1fr;gap:2px}.mobile-nav-drawer-link{min-height:52px!important;margin:0!important;padding:12px 2px!important;display:flex!important;align-items:center!important;justify-content:space-between!important;border:0!important;border-bottom:1px solid #E7EEF7!important;border-radius:0!important;background:#fff!important;color:#172033!important;font-size:18px!important;font-weight:600!important;line-height:1.3!important;text-decoration:none!important;box-shadow:none!important}.mobile-nav-drawer-link .nav-item-label{color:#172033!important}.mobile-nav-drawer-link.active,.mobile-nav-drawer-link[aria-current='page']{color:#234A84!important;background:#fff!important}.mobile-nav-drawer-link.active .nav-item-label,.mobile-nav-drawer-link[aria-current='page'] .nav-item-label{color:#234A84!important}.mobile-nav-drawer-footer{display:grid;grid-template-columns:1fr 1fr;align-items:end;gap:10px;padding:16px 22px max(20px,env(safe-area-inset-bottom));border-top:1px solid #E7EEF7;background:#F8FAFC;color:#172033}.mobile-nav-drawer-footer label,.mobile-nav-drawer-footer span{color:#172033!important}.mobile-nav-drawer-footer select{width:100%;min-height:46px;border:1px solid #DDE6F2;border-radius:13px;background:#fff;color:#172033}.mobile-nav-logout{grid-column:1/-1;min-height:50px;padding:0 18px;border:1px solid #234A84;border-radius:999px;background:#234A84;color:#fff;font:inherit;font-weight:750;cursor:pointer}body.mobile-nav-open{overflow:hidden}
