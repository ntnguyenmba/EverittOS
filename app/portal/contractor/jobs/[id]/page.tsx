...
const fieldCopy = {
  en: { start:'Start job', complete:'Complete job', updating:'Updating...', confirm:'Mark this job complete?', updateError:'Unable to update this job.', before:'Before photo', after:'After photo', addBefore:'Add before photo', addAfter:'Add after photo', photoSource:'Take a new photo or choose one from your phone gallery.', uploading:'Uploading photo...', photoAdded:'photo added.', photoError:'Photo could not be added.', jobDetails:'Job details', photos:'Photos', finish:'Finish job' },
  es: { start:'Iniciar trabajo', complete:'Completar trabajo', updating:'Actualizando...', confirm:'¿Marcar este trabajo como completado?', updateError:'No se pudo actualizar este trabajo.', before:'Foto antes', after:'Foto después', addBefore:'Agregar foto antes', addAfter:'Agregar foto después', photoSource:'Toma una foto nueva o elige una de la galería de tu teléfono.', uploading:'Subiendo foto...', photoAdded:'agregada.', photoError:'No se pudo agregar la foto.', jobDetails:'Detalles del trabajo', photos:'Fotos', finish:'Finalizar trabajo' },
  vi: { start:'Bắt đầu công việc', complete:'Hoàn thành công việc', updating:'Đang cập nhật...', confirm:'Đánh dấu công việc này đã hoàn thành?', updateError:'Không thể cập nhật công việc.', before:'Ảnh trước', after:'Ảnh sau', addBefore:'Thêm ảnh trước', addAfter:'Thêm ảnh sau', photoSource:'Chụp ảnh mới hoặc chọn ảnh có sẵn trong thư viện điện thoại.', uploading:'Đang tải ảnh...', photoAdded:'đã được thêm.', photoError:'Không thể thêm ảnh.', jobDetails:'Chi tiết công việc', photos:'Hình ảnh', finish:'Hoàn thành' }
} as const;
